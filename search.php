<html>
    ...
    <body>
        ...
        <div id="main">
            ...
            $q = $_GET['q'];
            echo " <b>$q</b><br><br>";
            $connect = mysqli_connect("localhost","root","","5mods");
            $query = "select zdjecie, pobran, polubien, nazwa, uzytkownicy.login, mody.id from mody join uzytkownicy on uzytkownik_id=uzytkownicy.id where nazwa like \"%$q%\" or uzytkownicy.login like \"%$q%\" order by id desc";
